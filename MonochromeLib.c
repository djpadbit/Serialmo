...
#ifdef ML_DISPLAY_VRAM_LINES
void ML_display_vram_lines(unsigned char startline, unsigned char endline)
{
	char *LCD_register_selector = (char*)0xB4000000, *LCD_data_register = (char*)0xB4010000, *vram;
	int i, j;
	vram = ML_vram_adress()+(startline*16);
